...
function updateLancamento(id, lancamento) {
    ...
    let index = dbLancamentos.data.map(obj => obj.id).indexOf(id);

    // Altera os dados do objeto no array
    dbLancamentos.data[index].nome = lancamento.conta
    dbLancamentos.data[index].valor = lancamento.valor

    window.alert("Lancamento alterada com sucesso");
