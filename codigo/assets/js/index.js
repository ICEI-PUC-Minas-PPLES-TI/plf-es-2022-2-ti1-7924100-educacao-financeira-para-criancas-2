...
const Storage = {
  ...
  const DOM = {
    ...
    addTransaction(transaction, index) {
      ...
      //adiciona uma transação em html usando a função "DOM.innerHTMLTransaction"
    ...
    innerHTMLTransaction(transaction, index) {
      ...
      const html = `
        ...
        <td>
            <img onclick="Transaction.remove(${index})" src="svg/BotaoSaida.svg" class="remove-transaction" alt="Remover transação">
        </td>
    `;
      return html;
    },
    ...
    //atualiza os cartões de saldo (receitas, despesas e saldo)
    ...
    clearTransactions() {
      ...
      //transações claras antes da atualização
  ...
  const Utils = {
    ...
    //formatação dos valores de formulário


    formatAmount(value) {
      value = Number(value) * 100;
  
      //verifica se o usuário adicionou um - (sinal de menos) em vez de selecionar botões de "Renda" e "Despesa"
  ...
  const Form = {
    ...
    getValues() {
      ...
      //Início do Menu que Recebe os Valores do Input
    ...
    submit(event) {
      ...
      try {
        ...
        //Verifica os Campos do Menu Modal antes de Enviar
  ...
  //Fim do Menu que Recebe os Valores do Input


  //Início do Menu do Chart Js (Gráfico Pizza)
          ...
          datasets: [
            {
              ...
              backgroundColor: ["#18cb18", "#ff0000", "#d0d1d9"],
              usePointStyle: true,
            },
          ],
  ...
  //Fim do Menu do Chart Js (Gráfico Pizza)
